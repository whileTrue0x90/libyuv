...
#if defined(HAS_SPLITRGBROW_SSE2)
  if (TestCpuFlag(kCpuHasSSE2)) {
    SplitRGBRow = SplitRGBRow_Any_SSE2;
    if (IS_ALIGNED(width, 16)) {
      SplitRGBRow = SplitRGBRow_SSE2;
    }
  }
#endif
...
#if defined(HAS_MERGERGBROW_SSE2)
  if (TestCpuFlag(kCpuHasSSE2)) {
    MergeRGBRow = MergeRGBRow_Any_SSE2;
    if (IS_ALIGNED(width, 16)) {
      MergeRGBRow = MergeRGBRow_SSE2;
    }
  }
#endif
