...
#ifdef HAS_HAMMINGDISTANCE_AVX2_orig

char kNibbleMask[32] = {15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15,
                        15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15,
                        15, 15, 15, 15, 15, 15, 15, 15, 15, 15};
char kBitCount[32] = {0, 1, 1, 2, 1, 2, 2, 3, 1, 2, 2, 3, 2, 3, 3, 4,
...
#ifdef HAS_HAMMINGDISTANCE_AVX2_1
static uint32 kNibbleMask = 0x0f0f0f0fu;
static vec8 kBitCount = {0, 1, 1, 2, 1, 2, 2, 3, 1, 2, 2, 3, 2, 3, 3, 4};
...
uint32 HammingDistance_AVX2_0(const uint8* src_a,
                              const uint8* src_b,
                              int count) {
  uint32 diff = 0u;
  ...
  asm volatile(
      ...
      "vpxor      0x20(%1),%%ymm5,%%ymm5         \n"
      "add        $0x40,%1                       \n"
      "vpand      %%ymm2,%%ymm5,%%ymm4           \n"
      "vpsrlw     $0x4,%%ymm5,%%ymm5             \n"
