...
#if ARGBToRGB24Row_AVX2_INTRINSIC
// Alternative implementation.  3600 ms vs 2400.
...
void ARGBToRGB24Row_AVX2(const uint8_t* src, uint8_t* dst, int width) {
  for (int i = 0; i < width; i += 8) {
    ...
    const char _ = ~0;  // zero the lane
    __m256i rgb_weird = _mm256_shuffle_epi8(rgba,
            _mm256_setr_epi8(0,1,2, 4,5,6, 8,9,10, 12,13,14, _,_,_,_,
                             0,1,2, 4,5,6, 8,9,10, 12,13,14, _,_,_,_));

    __m256i rgb = _mm256_permutevar8x32_epi32(rgb_weird,
...
static const ulvec8 kPermARGBToRGB24_0 = {
  0u, 1u, 2u, 4u, 5u, 6u, 8u, 9u, 10u, 12u, 13u, 14u, 16u, 17u, 18u, 20u, 21u, 22u, 24u, 25u, 26u, 28u, 29u, 30u, 32u, 33u, 34u, 36u, 37u, 38u, 40u, 41u
};
static const ulvec8 kPermARGBToRGB24_1 = {
  10u, 12u, 13u, 14u, 16u, 17u, 18u, 20u, 21u, 22u, 24u, 25u, 26u, 28u, 29u, 30u, 32u, 33u, 34u, 36u, 37u, 38u, 40u, 41u, 42u, 44u, 45u, 46u, 48u, 49u, 50u, 52u
};
static const ulvec8 kPermARGBToRGB24_2 = {
  21u, 22u, 24u, 25u, 26u, 28u, 29u, 30u, 32u, 33u, 34u, 36u, 37u, 38u, 40u, 41u, 42u, 44u, 45u, 46u, 48u, 49u, 50u, 52u, 53u, 54u, 56u, 57u, 58u, 60u, 61u, 62u
};
