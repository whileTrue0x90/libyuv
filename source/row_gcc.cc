...
#define YUVTORGB_SETUP_AVX2(yuvconstants)
#define YUVTORGB16_AVX2(yuvconstants)                                 \
  "vmovdqa     96(%[yuvconstants]),%%ymm0                         \n" \
  "vpaddb      %%ymm3,%%ymm0,%%ymm3                               \n" \
  "vpmulhuw    128(%[yuvconstants]),%%ymm4,%%ymm4                 \n" \
