...
#define YUVTORGB_SETUP_AVX2(yuvconstants)                             \
  ...
  "vmovdqa     256(%[yuvconstants]),%%ymm15                       \n" \
  "vmovdqa     288(%[yuvconstants]),%%ymm7                        \n"
