...
#define READYUV422_AVX512F_BW_VL                                      \
  "vmovdqu    (%[u_buf]),%%xmm3                                   \n" \
  "vmovdqu    0x00(%[u_buf],%[v_buf],1),%%xmm1                    \n" \
...
#define YUVTORGB_SETUP_AVX512F_BW_VL(yuvconstants)                    \
  "vpcmpeqb   %%xmm13,%%xmm13,%%xmm13                             \n" \
  "movdqa     (%[yuvconstants]),%%xmm8                            \n" \
...
#define YUVTORGB16_AVX512F_BW_VL(yuvconstants)                        \
...
#define YUVTORGB_REGS_AVX512F_BW_VL "xmm8", "xmm9", "xmm10", "xmm11", "xmm12", "xmm13", "xmm16", "xmm17", "xmm18",
...
#define YUVTORGB_AVX512F_BW_VL(yuvconstants)                          \
  YUVTORGB16_AVX512F_BW_VL(yuvconstants)                              \
...
#define STOREARGB_AVX512F_BW_VL                                       \
...
#if defined(HAS_I422TOARGBROW_AVX512F_BW_VL)
...
// 32 pixels
// 16 UV values upsampled to 32 UV, mixed with 32 Y producing 32 ARGB (128 bytes).
void OMITFP I422ToARGBRow_AVX512F_BW_VL(const uint8_t* y_buf,
                                        const uint8_t* u_buf,
                                        const uint8_t* v_buf,
                                        uint8_t* dst_argb,
                                        const struct YuvConstants* yuvconstants,
                                        int width) {
  asm volatile (
    YUVTORGB_SETUP_AVX512F_BW_VL(yuvconstants)
      "sub         %[u_buf],%[v_buf]             \n"
    ...
    LABELALIGN
      "1:                                        \n"
    READYUV422_AVX512F_BW_VL
    YUVTORGB_AVX512F_BW_VL(yuvconstants)
    STOREARGB_AVX512F_BW_VL
      "sub         $0x20,%[width]                \n"
      "jg          1b                            \n"
  ...
  : "memory", "cc", YUVTORGB_REGS_AVX512F_BW_VL
    "xmm0", "xmm1", "xmm2", "xmm3", "xmm4", "xmm5"
  );
}
#endif  // HAS_I422TOARGBROW_AVX512F_BW_VL
