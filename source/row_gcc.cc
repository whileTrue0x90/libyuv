...
void RGB565ToARGBRow_SSE2(const uint8* src, uint8* dst, int width) {
  asm volatile(
      ...
      "punpcklbw %%xmm0,%%xmm1                   \n"
      "punpckhbw %%xmm0,%%xmm2                   \n" MEMOPMEM(
          movdqu, xmm1, 0x00, 1, 0, 2)       //  movdqu  %%xmm1,(%1,%0,2)
...
void ARGB4444ToARGBRow_SSE2(const uint8* src, uint8* dst, int width) {
  asm volatile(
      ...
      "punpcklbw %%xmm2,%%xmm0                   \n"
      "punpckhbw %%xmm2,%%xmm1                   \n" MEMOPMEM(
          movdqu, xmm0, 0x00, 1, 0, 2)       //  movdqu  %%xmm0,(%1,%0,2)
...
void ARGBToUVRow_SSSE3(const uint8* src_argb0,
  ...
  asm volatile(
      ...
      "1:                                        \n"
      "movdqu    (%0),%%xmm0                     \n" MEMOPREG(
          movdqu, 0x00, 0, 4, 1, xmm7)  //  movdqu (%0,%4,1),%%xmm7
      "pavgb     %%xmm7,%%xmm0                   \n"
      "movdqu    0x10(%0),%%xmm1                 \n" MEMOPREG(
          movdqu, 0x10, 0, 4, 1, xmm7)  //  movdqu 0x10(%0,%4,1),%%xmm7
      "pavgb     %%xmm7,%%xmm1                   \n"
      "movdqu    0x20(%0),%%xmm2                 \n" MEMOPREG(
          movdqu, 0x20, 0, 4, 1, xmm7)  //  movdqu 0x20(%0,%4,1),%%xmm7
      "pavgb     %%xmm7,%%xmm2                   \n"
      "movdqu    0x30(%0),%%xmm6                 \n" MEMOPREG(
          movdqu, 0x30, 0, 4, 1, xmm7)  //  movdqu 0x30(%0,%4,1),%%xmm7
      "pavgb     %%xmm7,%%xmm6                   \n"
      ...
      "paddb     %%xmm5,%%xmm0                   \n"
      "movlps    %%xmm0,(%1)                     \n" MEMOPMEM(
          movhps, xmm0, 0x00, 1, 2, 1)  //  movhps    %%xmm0,(%1,%2,1)
      "lea       0x8(%1),%1                      \n"
      "sub       $0x10,%3                        \n"
      "jg        1b                              \n"
      : "+r"(src_argb0),                   // %0
...
void ARGBToUV444Row_SSSE3(const uint8* src_argb,
  ...
  asm volatile(
      ...
      "paddb     %%xmm5,%%xmm0                   \n"
      "lea       0x40(%0),%0                     \n" MEMOPMEM(
          movdqu, xmm0, 0x00, 1, 2, 1)  //  movdqu  %%xmm0,(%1,%2,1)
      "lea       0x10(%1),%1                     \n"
      "sub       $0x10,%3                        \n"
      "jg        1b                              \n"
      : "+r"(src_argb),  // %0
...
void MirrorRow_SSSE3(const uint8* src, uint8* dst, int width) {
  ...
  asm volatile("movdqa    %3,%%xmm5                       \n"
               ...
               LABELALIGN
               "1:                                        \n" MEMOPREG(
                   movdqu, -0x10, 0, 2, 1, xmm0)  //  movdqu -0x10(%0,%2),%%xmm0
               "pshufb    %%xmm5,%%xmm0                   \n"
               "movdqu    %%xmm0,(%1)                     \n"
               "lea       0x10(%1),%1                     \n"
               "sub       $0x10,%2                        \n"
...
void MirrorRow_AVX2(const uint8* src, uint8* dst, int width) {
  ...
  asm volatile(
      ...
      LABELALIGN "1:                                        \n" MEMOPREG(
          vmovdqu, -0x20, 0, 2, 1, ymm0)  //  vmovdqu -0x20(%0,%2),%%ymm0
...
void MirrorUVRow_SSSE3(const uint8* src,
  ...
  asm volatile(
      ...
      "pshufb    %%xmm1,%%xmm0                   \n"
      "movlpd    %%xmm0,(%1)                     \n" MEMOPMEM(
          movhpd, xmm0, 0x00, 1, 2, 1)  //  movhpd    %%xmm0,(%1,%2)
      "lea       0x8(%1),%1                      \n"
      "sub       $8,%3                           \n"
      "jg        1b                              \n"
      : "+r"(src),             // %0
...
void ARGBMirrorRow_AVX2(const uint8* src, uint8* dst, int width) {
  ...
  asm volatile("vmovdqu    %3,%%ymm5                      \n"
               ...
               LABELALIGN
               "1:                                        \n" VMEMOPREG(
                   vpermd, -0x20, 0, 2, 4, ymm5,
                   ymm0)  // vpermd -0x20(%0,%2,4),ymm5,ymm0
               "vmovdqu    %%ymm0,(%1)                    \n"
               "lea        0x20(%1),%1                    \n"
               "sub        $0x8,%2                        \n"
               "jg         1b                             \n"
...
void SplitUVRow_AVX2(const uint8* src_uv,
  ...
  asm volatile(
      ...
      "vpermq     $0xd8,%%ymm2,%%ymm2            \n"
      "vmovdqu    %%ymm0,(%1)                    \n" MEMOPMEM(
          vmovdqu, ymm2, 0x00, 1, 2, 1)  //  vmovdqu %%ymm2,(%1,%2)
      "lea        0x20(%1),%1                    \n"
      "sub        $0x20,%3                       \n"
      "jg         1b                             \n"
      "vzeroupper                                \n"
...
void SplitUVRow_SSE2(const uint8* src_uv,
  ...
  asm volatile(
      ...
      "packuswb   %%xmm3,%%xmm2                  \n"
      "movdqu     %%xmm0,(%1)                    \n" MEMOPMEM(
          movdqu, xmm2, 0x00, 1, 2, 1)  //  movdqu     %%xmm2,(%1,%2)
      "lea        0x10(%1),%1                    \n"
      "sub        $0x10,%3                       \n"
      "jg         1b                             \n"
      : "+r"(src_uv),  // %0
...
void MergeUVRow_AVX2(const uint8* src_u,
  ...
  asm volatile("sub       %0,%1                           \n"
               ...
               "1:                                        \n"
               "vmovdqu   (%0),%%ymm0                     \n" MEMOPREG(
                   vmovdqu, 0x00, 0, 1, 1, ymm1)  //  vmovdqu (%0,%1,1),%%ymm1
               "lea       0x20(%0),%0                     \n"
...
void MergeUVRow_SSE2(const uint8* src_u,
  ...
  asm volatile("sub       %0,%1                           \n"
               ...
               "1:                                        \n"
               "movdqu    (%0),%%xmm0                     \n" MEMOPREG(
                   movdqu, 0x00, 0, 1, 1, xmm1)  //  movdqu    (%0,%1,1),%%xmm1
               "lea       0x10(%0),%0                     \n"
               "movdqa    %%xmm0,%%xmm2                   \n"
               "punpcklbw %%xmm1,%%xmm0                   \n"
               "punpckhbw %%xmm1,%%xmm2                   \n"
...
void YUY2ToUVRow_SSE2(const uint8* src_yuy2,
  ...
  asm volatile(
      ...
      "movdqu    (%0),%%xmm0                     \n"
      "movdqu    0x10(%0),%%xmm1                 \n" MEMOPREG(
          movdqu, 0x00, 0, 4, 1, xmm2)       //  movdqu  (%0,%4,1),%%xmm2
      ...
      "packuswb  %%xmm1,%%xmm1                   \n"
      "movq      %%xmm0,(%1)                     \n" MEMOPMEM(
          movq, xmm1, 0x00, 1, 2, 1)  //  movq    %%xmm1,(%1,%2)
      "lea       0x8(%1),%1                      \n"
      "sub       $0x10,%3                        \n"
      "jg        1b                              \n"
      : "+r"(src_yuy2),               // %0
...
void ARGBAttenuateRow_AVX2(const uint8* src_argb, uint8* dst_argb, int width) {
  asm volatile(
      ...
      "vpackuswb  %%ymm1,%%ymm0,%%ymm0           \n"
      "vpor       %%ymm6,%%ymm0,%%ymm0           \n" MEMOPMEM(
          vmovdqu, ymm0, 0x00, 0, 1, 1)  //  vmovdqu %%ymm0,(%0,%1)
      "lea       0x20(%0),%0                     \n"
      "sub        $0x8,%2                        \n"
      "jg        1b                              \n"
      "vzeroupper                                \n"
...
void ARGBUnattenuateRow_SSE2(const uint8* src_argb,
  ...
  asm volatile(
      ...
      "movzb     0x03(%0),%3                     \n"
      "punpcklbw %%xmm0,%%xmm0                   \n" MEMOPREG(
          movd, 0x00, 4, 3, 4, xmm2)  //  movd      0x0(%4,%3,4),%%xmm2
      "movzb     0x07(%0),%3                     \n" MEMOPREG(
          movd, 0x00, 4, 3, 4, xmm3)  //  movd      0x0(%4,%3,4),%%xmm3
...
void ARGBUnattenuateRow_AVX2(const uint8* src_argb,
  ...
  asm volatile(
      ...
      // replace VPGATHER
      "movzb     0x03(%0),%3                     \n" MEMOPREG(
          vmovd, 0x00, 4, 3, 4, xmm0)  //  vmovd 0x0(%4,%3,4),%%xmm0
      "movzb     0x07(%0),%3                     \n" MEMOPREG(
          vmovd, 0x00, 4, 3, 4, xmm1)  //  vmovd 0x0(%4,%3,4),%%xmm1
      "movzb     0x0b(%0),%3                     \n"
      "vpunpckldq %%xmm1,%%xmm0,%%xmm6           \n" MEMOPREG(
          vmovd, 0x00, 4, 3, 4, xmm2)  //  vmovd 0x0(%4,%3,4),%%xmm2
      "movzb     0x0f(%0),%3                     \n" MEMOPREG(
          vmovd, 0x00, 4, 3, 4, xmm3)  //  vmovd 0x0(%4,%3,4),%%xmm3
      "movzb     0x13(%0),%3                     \n"
...
void SobelXRow_SSE2(const uint8* src_y0,
  ...
  asm volatile(
      ...
      "punpcklbw %%xmm5,%%xmm1                   \n"
      "psubw     %%xmm1,%%xmm0                   \n" MEMOPREG(
          movq, 0x00, 0, 1, 1, xmm1)       //  movq      (%0,%1,1),%%xmm1
      MEMOPREG(movq, 0x02, 0, 1, 1, xmm2)  //  movq      0x2(%0,%1,1),%%xmm2
      "punpcklbw %%xmm5,%%xmm1                   \n"
      "punpcklbw %%xmm5,%%xmm2                   \n"
      "psubw     %%xmm2,%%xmm1                   \n" MEMOPREG(
          movq, 0x00, 0, 2, 1, xmm2)       //  movq      (%0,%2,1),%%xmm2
      ...
      "pmaxsw    %%xmm1,%%xmm0                   \n"
      "packuswb  %%xmm0,%%xmm0                   \n" MEMOPMEM(
          movq, xmm0, 0x00, 0, 3, 1)  //  movq      %%xmm0,(%0,%3,1)
      "lea       0x8(%0),%0                      \n"
      "sub       $0x8,%4                         \n"
      "jg        1b                              \n"
      : "+r"(src_y0),      // %0
...
void SobelYRow_SSE2(const uint8* src_y0,
  ...
  asm volatile(
      ...
      "psubw     %%xmm1,%%xmm0                   \n"
      "movq      0x1(%0),%%xmm1                  \n" MEMOPREG(
          movq, 0x01, 0, 1, 1, xmm2)  //  movq      0x1(%0,%1,1),%%xmm2
      "punpcklbw %%xmm5,%%xmm1                   \n"
      "punpcklbw %%xmm5,%%xmm2                   \n"
      "psubw     %%xmm2,%%xmm1                   \n"
      "movq      0x2(%0),%%xmm2                  \n" MEMOPREG(
          movq, 0x02, 0, 1, 1, xmm3)  //  movq      0x2(%0,%1,1),%%xmm3
      "punpcklbw %%xmm5,%%xmm2                   \n"
      "punpcklbw %%xmm5,%%xmm3                   \n"
      "psubw     %%xmm3,%%xmm2                   \n"
      "paddw     %%xmm2,%%xmm0                   \n"
      ...
      "pmaxsw    %%xmm1,%%xmm0                   \n"
      "packuswb  %%xmm0,%%xmm0                   \n" MEMOPMEM(
          movq, xmm0, 0x00, 0, 2, 1)  //  movq      %%xmm0,(%0,%2,1)
      "lea       0x8(%0),%0                      \n"
      "sub       $0x8,%3                         \n"
      "jg        1b                              \n"
      : "+r"(src_y0),      // %0
...
=======
  asm volatile(
      ...
      "movdqu    0x20(%0),%%xmm2                 \n"
      "movdqu    0x30(%0),%%xmm3                 \n" MEMOPREG(
          psubd, 0x00, 0, 4, 4, xmm0)       // psubd    0x00(%0,%4,4),%%xmm0
      MEMOPREG(psubd, 0x10, 0, 4, 4, xmm1)  // psubd    0x10(%0,%4,4),%%xmm1
      MEMOPREG(psubd, 0x20, 0, 4, 4, xmm2)  // psubd    0x20(%0,%4,4),%%xmm2
      MEMOPREG(psubd, 0x30, 0, 4, 4, xmm3)  // psubd    0x30(%0,%4,4),%%xmm3
      "lea       0x40(%0),%0                     \n"
      ...
      "psubd     0x20(%1),%%xmm2                 \n"
      "psubd     0x30(%1),%%xmm3                 \n" MEMOPREG(
          paddd, 0x00, 1, 4, 4, xmm0)       // paddd    0x00(%1,%4,4),%%xmm0
      MEMOPREG(paddd, 0x10, 1, 4, 4, xmm1)  // paddd    0x10(%1,%4,4),%%xmm1
      MEMOPREG(paddd, 0x20, 1, 4, 4, xmm2)  // paddd    0x20(%1,%4,4),%%xmm2
      MEMOPREG(paddd, 0x30, 1, 4, 4, xmm3)  // paddd    0x30(%1,%4,4),%%xmm3
      "lea       0x40(%1),%1                     \n"
...
void ARGBAffineRow_SSE2(const uint8* src_argb,
  ...
  asm volatile(
      ...
      LABELALIGN
      "40:                                         \n"
      "cvttps2dq %%xmm2,%%xmm0                   \n"  // x, y float to int first
                                                      // 2
      "cvttps2dq %%xmm3,%%xmm1                   \n"  // x, y float to int next
                                                      // 2
      "packssdw  %%xmm1,%%xmm0                   \n"  // x, y as 8 shorts
      "pmaddwd   %%xmm5,%%xmm0                   \n"  // off = x * 4 + y *
                                                      // stride
      ...
      "movd      %%xmm0,%k5                      \n"
      "pshufd    $0x39,%%xmm0,%%xmm0             \n" MEMOPREG(
          movd, 0x00, 0, 1, 1, xmm1)       //  movd      (%0,%1,1),%%xmm1
      ...
      "pshufd    $0x39,%%xmm0,%%xmm0             \n"
      "movd      %%xmm0,%k5                      \n" MEMOPREG(
          movd, 0x00, 0, 1, 1, xmm0)       //  movd      (%0,%1,1),%%xmm0
      MEMOPREG(movd, 0x00, 0, 5, 1, xmm6)  //  movd      (%0,%5,1),%%xmm6
      "punpckldq %%xmm6,%%xmm0                   \n"
      "addps     %%xmm4,%%xmm3                   \n"
      "movq      %%xmm0,0x08(%2)                 \n"
...
=======
  asm volatile("sub       %1,%2                             \n" LABELALIGN
               "1:                                        \n"
               "movq      (%1),%%xmm2                       \n" MEMOPREG(
                   movq, 0x00, 1, 2, 1, xmm3)  //  movq    (%1,%2,1),%%xmm3
               "lea       0x8(%1),%1                        \n"
               "punpcklbw %%xmm3,%%xmm2                     \n"
               "movdqu    (%0),%%xmm0                       \n"
               "lea       0x10(%0),%0                       \n"
