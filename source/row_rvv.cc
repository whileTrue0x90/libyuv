...
void ARGBToAB64Row_RVV(const uint8_t* src_argb, uint16_t* dst_ab64, int width) {
  ...
  do {
    ...
    v_dst_ab64 = __riscv_vset_v_u16m2_u16m2x4(v_dst_ab64, 0, v_r_16);
    v_dst_ab64 = __riscv_vset_v_u16m2_u16m2x4(v_dst_ab64, 1, v_g_16);
    v_dst_ab64 = __riscv_vset_v_u16m2_u16m2x4(v_dst_ab64, 2, v_b_16);
    v_dst_ab64 = __riscv_vset_v_u16m2_u16m2x4(v_dst_ab64, 3, v_a_16);
...
void AB64ToARGBRow_RVV(const uint16_t* src_ab64, uint8_t* dst_argb, int width) {
  ...
  do {
    ...
    v_dst_argb = __riscv_vset_v_u8m1_u8m1x4(v_dst_argb, 0, v_b);
    v_dst_argb = __riscv_vset_v_u8m1_u8m1x4(v_dst_argb, 1, v_g);
    v_dst_argb = __riscv_vset_v_u8m1_u8m1x4(v_dst_argb, 2, v_r);
    v_dst_argb = __riscv_vset_v_u8m1_u8m1x4(v_dst_argb, 3, v_a);
...
void RAWToARGBRow_RVV(const uint8_t* src_raw, uint8_t* dst_argb, int width) {
  ...
  v_dst_argb = __riscv_vset_v_u8m2_u8m2x4(v_dst_argb, 3, v_a);
  do {
    ...
    v_dst_argb = __riscv_vset_v_u8m2_u8m2x4(v_dst_argb, 0, v_b);
    v_dst_argb = __riscv_vset_v_u8m2_u8m2x4(v_dst_argb, 1, v_g);
    v_dst_argb = __riscv_vset_v_u8m2_u8m2x4(v_dst_argb, 2, v_r);
...
void RAWToRGBARow_RVV(const uint8_t* src_raw, uint8_t* dst_rgba, int width) {
  ...
  vuint8m2_t v_a = __riscv_vmv_v_x_u8m2(255u, vl);
  v_dst_rgba = __riscv_vset_v_u8m2_u8m2x4(v_dst_rgba, 0, v_a);
  do {
    vuint8m2x3_t v_bgr = __riscv_vlseg3e8_v_u8m2x3(src_raw, vl);
    vuint8m2_t v_r = __riscv_vget_v_u8m2x3_u8m2(v_bgr, 0);
    vuint8m2_t v_g = __riscv_vget_v_u8m2x3_u8m2(v_bgr, 1);
    vuint8m2_t v_b = __riscv_vget_v_u8m2x3_u8m2(v_bgr, 2);
    v_dst_rgba = __riscv_vset_v_u8m2_u8m2x4(v_dst_rgba, 1, v_b);
    v_dst_rgba = __riscv_vset_v_u8m2_u8m2x4(v_dst_rgba, 2, v_g);
    v_dst_rgba = __riscv_vset_v_u8m2_u8m2x4(v_dst_rgba, 3, v_r);
...
void RAWToRGB24Row_RVV(const uint8_t* src_raw, uint8_t* dst_rgb24, int width) {
  ...
  do {
    ...
    vuint8m2_t v_g = __riscv_vget_v_u8m2x3_u8m2(v_bgr, 1);
    vuint8m2_t v_b = __riscv_vget_v_u8m2x3_u8m2(v_bgr, 2);
    v_dst_rgb = __riscv_vset_v_u8m2_u8m2x3(v_dst_rgb, 0, v_b);
    v_dst_rgb = __riscv_vset_v_u8m2_u8m2x3(v_dst_rgb, 1, v_g);
    v_dst_rgb = __riscv_vset_v_u8m2_u8m2x3(v_dst_rgb, 2, v_r);
...
void ARGBToRAWRow_RVV(const uint8_t* src_argb, uint8_t* dst_raw, int width) {
  ...
  do {
    ...
    v_dst_bgr = __riscv_vset_v_u8m2_u8m2x3(v_dst_bgr, 0, v_r);
    v_dst_bgr = __riscv_vset_v_u8m2_u8m2x3(v_dst_bgr, 1, v_g);
    v_dst_bgr = __riscv_vset_v_u8m2_u8m2x3(v_dst_bgr, 2, v_b);
...
void I400ToARGBRow_RVV(const uint8_t* src_y,
  ...
  do {
    ...
    v_dst_argb = __riscv_vset_v_u8m2_u8m2x4(v_dst_argb, 0, v_out);
    v_dst_argb = __riscv_vset_v_u8m2_u8m2x4(v_dst_argb, 1, v_out);
    v_dst_argb = __riscv_vset_v_u8m2_u8m2x4(v_dst_argb, 2, v_out);
    v_dst_argb = __riscv_vset_v_u8m2_u8m2x4(v_dst_argb, 3, v_a);
    __riscv_vsseg4e8_v_u8m2x4(dst_argb, v_dst_argb, vl);
    w -= vl;
    src_y += vl;
...
void J400ToARGBRow_RVV(const uint8_t* src_y, uint8_t* dst_argb, int width) {
  ...
  do {
    vuint8m2_t v_y;
    v_y = __riscv_vle8_v_u8m2(src_y, vl);
    v_dst_argb = __riscv_vset_v_u8m2_u8m2x4(v_dst_argb, 0, v_y);
    v_dst_argb = __riscv_vset_v_u8m2_u8m2x4(v_dst_argb, 1, v_y);
    v_dst_argb = __riscv_vset_v_u8m2_u8m2x4(v_dst_argb, 2, v_y);
    __riscv_vsseg4e8_v_u8m2x4(dst_argb, v_dst_argb, vl);
    w -= vl;
    src_y += vl;
    dst_argb += vl * 4;
...
void MergeRGBRow_RVV(const uint8_t* src_r,
  ...
  do {
    ...
    vuint8m2x3_t v_dst;
    v_dst = __riscv_vset_v_u8m2_u8m2x3(v_dst, 0, v_r);
    v_dst = __riscv_vset_v_u8m2_u8m2x3(v_dst, 1, v_g);
    v_dst = __riscv_vset_v_u8m2_u8m2x3(v_dst, 2, v_b);
...
void MergeARGBRow_RVV(const uint8_t* src_r,
  ...
  do {
    ...
    vuint8m2x4_t v_dst;
    v_dst = __riscv_vset_v_u8m2_u8m2x4(v_dst, 0, v_b);
    v_dst = __riscv_vset_v_u8m2_u8m2x4(v_dst, 1, v_g);
    v_dst = __riscv_vset_v_u8m2_u8m2x4(v_dst, 2, v_r);
    v_dst = __riscv_vset_v_u8m2_u8m2x4(v_dst, 3, v_a);
...
void MergeUVRow_RVV(const uint8_t* src_u,
  ...
  do {
    ...
    v_dst = __riscv_vset_v_u8m4_u8m4x2(v_dst, 0, v_u);
    v_dst = __riscv_vset_v_u8m4_u8m4x2(v_dst, 1, v_v);
...
void ARGBBlendRow_RVV(const uint8_t* src_argb,
  ...
  v_dst_argb = __riscv_vset_v_u8m2_u8m2x4(v_dst_argb, 3, v_255);
  do {
    ...
    v_dst_argb = __riscv_vset_v_u8m2_u8m2x4(v_dst_argb, 0, v_dst_b);
    v_dst_argb = __riscv_vset_v_u8m2_u8m2x4(v_dst_argb, 1, v_dst_g);
    v_dst_argb = __riscv_vset_v_u8m2_u8m2x4(v_dst_argb, 2, v_dst_r);
    __riscv_vsseg4e8_v_u8m2x4(dst_argb, v_dst_argb, vl);
