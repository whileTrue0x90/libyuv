...
static int InitYuvConstantsWithMatrix(struct YuvConstants* yuvconstants,
  ...
  if (yuv) {
    ...
    const uint16_t UBU = (uint16_t)(-UB);
    const uint16_t VRU = (uint16_t)(-VR);
    const uint16_t UGU = (uint16_t)(UG);
    const uint16_t VGU = (uint16_t)(VG);
    *yuvconstants = {{UBU, VRU, UBU, VRU, UBU, VRU, UBU, VRU},
    ...
    const uint8_t UBU = (uint8_t)(-UB);
    const uint8_t VRU = (uint8_t)(-VR);
    const uint8_t UGU = (uint8_t)(UG);
    const uint8_t VGU = (uint8_t)(VG);
    *yuvconstants = {
        {UBU, UBU, UBU, UBU, VRU, VRU, VRU, VRU, 0, 0, 0, 0, 0, 0, 0, 0},
    ...
    *yuvconstants = {
    ...
    const uint16_t UGU = (uint16_t)(UG);
    const uint16_t VGU = (uint16_t)(VG);
    *yuvconstants = {{VRU, UBU, VRU, UBU, VRU, UBU, VRU, UBU},
    ...
    const uint8_t VGU = (uint8_t)(VG);
    *yuvconstants = {
        {VRU, VRU, VRU, VRU, UBU, UBU, UBU, UBU, 0, 0, 0, 0, 0, 0, 0, 0},
...
int InitYuvConstantsWithMCCodePoint(struct YuvConstants* yuvconstants,
                                    MatrixCoefficientsEnum code_point,
                                    int full_range,
                                    int yuv) {
  ...
  switch (code_point) {
    case kMatrixCoefficientsBT709:
    case kMatrixCoefficientsFCC:
    case kMatrixCoefficientsBT470BG:
    case kMatrixCoefficientsBT601:
    case kMatrixCoefficientsSMPTE240:
    case kMatrixCoefficientsBT2020NCL: {
...
int InitYuvConstantsWithCPCodePoint(struct YuvConstants* yuvconstants,
  ...
  switch (code_point) {
    case kColorPrimariesBT709:
    case kColorPrimariesBT470M:
    case kColorPrimariesBT470BG:
    case kColorPrimariesBT601:
    case kColorPrimariesSMPTE240:
    case kColorPrimariesGenericFilm:
    case kColorPrimariesBT2020:
    case kColorPrimariesXYZ:
    case kColorPrimariesSMPTE431:
    case kColorPrimariesSMPTE432:
    case kColorPrimariesEBU3213:
