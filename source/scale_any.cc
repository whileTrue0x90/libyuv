...
SUH2LANY(ScaleColUp2_Linear_Any_C,
         ScaleColUp2_Linear_C,
         ScaleColUp2_Linear_C,
         0,
         uint8_t)

SUH2LANY(ScaleColUp2_Linear_16_Any_C,
         ScaleColUp2_Linear_16_C,
         ScaleColUp2_Linear_16_C,
         0,
         uint16_t)

#ifdef HAS_SCALECOLUP2LINEAR_SSE2
SUH2LANY(ScaleColUp2_Linear_Any_SSE2,
         ScaleColUp2_Linear_SSE2,
         ScaleColUp2_Linear_C,
         15,
         uint8_t)
#endif
...
SUH2LANY(ScaleColUp2_Linear_Any_SSSE3,
         ScaleColUp2_Linear_SSSE3,
         ScaleColUp2_Linear_C,
         15,
         uint8_t)
#endif
...
SUH2LANY(ScaleColUp2_Linear_16_Any_SSE2,
         ScaleColUp2_Linear_16_SSE2,
         ScaleColUp2_Linear_16_C,
         15,
         uint16_t)
#endif
...
SUH2LANY(ScaleColUp2_Linear_Any_AVX2,
         ScaleColUp2_Linear_AVX2,
         ScaleColUp2_Linear_C,
         31,
         uint8_t)
#endif
...
SUH2LANY(ScaleColUp2_Linear_16_Any_AVX2,
         ScaleColUp2_Linear_16_AVX2,
         ScaleColUp2_Linear_16_C,
         15,
         uint16_t)
#endif
...
SUH2LANY(ScaleColUp2_Linear_Any_NEON,
         ScaleColUp2_Linear_NEON,
         ScaleColUp2_Linear_C,
         15,
         uint8_t)
#endif
...
SUH2LANY(ScaleColUp2_Linear_16_Any_NEON,
         ScaleColUp2_Linear_16_NEON,
         ScaleColUp2_Linear_16_C,
         15,
         uint16_t)
#endif
...
#define SU2BLANY(NAME, SIMD, C, MASK, PTYPE)                            \
  void NAME(const PTYPE* src_ptr, ptrdiff_t src_stride, PTYPE* dst_ptr, \
    ...
    if (work_width > 0) {                                               \
      ...
      C(sa + (n / 2), sb - sa, da + n + 1, db - da, r & ~1);            \
    }                                                                   \
  }
