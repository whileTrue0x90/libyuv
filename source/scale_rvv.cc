...
void ScaleARGBRowDown2Linear_RVV(const uint8_t* src_argb,
  ...
  do {
    ...
    __riscv_vlseg2e32_v_u32m4(&v_odd_32, &v_even_32, src, vl);
    ...
    v_dst = __riscv_vaaddu_vv_u8m4(v_odd, v_even, vl * 4);
...
void ScaleARGBRowDown2Box_RVV(const uint8_t* src_argb,
  ...
  do {
    ...
    size_t vl = __riscv_vsetvl_e32m4(w);
    __riscv_vlseg2e32_v_u32m4(&v_row0_odd_32, &v_row0_even_32, src0, vl);
    __riscv_vlseg2e32_v_u32m4(&v_row1_odd_32, &v_row1_even_32, src1, vl);
    ...
    v_row0_sum = __riscv_vwaddu_vv_u16m8(v_row0_odd, v_row0_even, vl * 4);
    v_row1_sum = __riscv_vwaddu_vv_u16m8(v_row1_odd, v_row1_even, vl * 4);
