...
#ifdef HAS_MERGEAR30ROW_AVX2
ANY31PT(MergeAR30Row_Any_AVX2, MergeAR30Row_AVX2, uint16_t, 2, uint8_t, 4, 15)
#endif

#ifdef HAS_MERGEAR30ROW_NEON
ANY31PT(MergeAR30Row_Any_NEON, MergeAR30Row_NEON, uint16_t, 2, uint8_t, 4, 3)
#endif
