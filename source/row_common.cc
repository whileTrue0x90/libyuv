...
static __inline constexpr int16_t YuvConstantsKY(float ky) noexcept {
  return (int16_t)RoundYuvCoefficient(ky * 64 * 256 * 256 / 257);
}

static __inline constexpr int8_t YuvConstantsKUV(float kuv) noexcept {
  return (int8_t)RoundYuvCoefficient(ClampYuvCoefficient8(kuv * 64));
}

static __inline constexpr int16_t YuvConstantsBY(float ky, float by) noexcept {
  return (int16_t)RoundYuvCoefficient(-ky * by * 64 * 255 + 32);
}

static __inline constexpr int16_t YuvConstantsBRGB(int16_t by,
                                                   int8_t ku,
                                                   float bu,
                                                   int8_t kv,
                                                   float bv) noexcept {
