...
// I422ToRGB24Row_SSSE3 implemented in row_gcc.cc
// For row_win Visual C (not clangcl)
#if defined(HAS_I422TORGB24ROW_SSSE3) && defined(_MSC_VER) && !defined(__clang__)
...
// SSSE3 implemented in row_gcc.cc
// For row_win Visual C (not clangcl)
#if defined(HAS_I444TORGB24ROW_SSSE3) && defined(_MSC_VER) && !defined(__clang__)
