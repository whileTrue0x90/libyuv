...
void ScaleRowDown2Box_SSSE3(const uint8* src_ptr,
  ...
  asm volatile(
      ...
      "movdqu    (%0),%%xmm0                     \n"
      "movdqu    0x10(%0),%%xmm1                 \n" MEMOPREG(
          movdqu, 0x00, 0, 3, 1, xmm2)       //  movdqu  (%0,%3,1),%%xmm2
...
void ScaleRowDown2Box_AVX2(const uint8* src_ptr,
  ...
  asm volatile(
      ...
      "vmovdqu    (%0),%%ymm0                    \n"
      "vmovdqu    0x20(%0),%%ymm1                \n" MEMOPREG(
          vmovdqu, 0x00, 0, 3, 1, ymm2)       //  vmovdqu  (%0,%3,1),%%ymm2
...
void ScaleRowDown4Box_SSSE3(const uint8* src_ptr,
  ...
  asm volatile(
      ...
      "paddw      %%xmm2,%%xmm0                  \n"
      "paddw      %%xmm3,%%xmm1                  \n" MEMOPREG(
          movdqu, 0x00, 0, 4, 2, xmm2)       //  movdqu  (%0,%4,2),%%xmm2
...
void ScaleRowDown4Box_AVX2(const uint8* src_ptr,
  ...
  asm volatile(
      ...
      "vpaddw     %%ymm2,%%ymm0,%%ymm0           \n"
      "vpaddw     %%ymm3,%%ymm1,%%ymm1           \n" MEMOPREG(
          vmovdqu, 0x00, 0, 3, 2, ymm2)       //  vmovdqu  (%0,%3,2),%%ymm2
      MEMOPREG(vmovdqu, 0x20, 0, 3, 2, ymm3)  //  vmovdqu  0x20(%0,%3,2),%%ymm3
      "vpmaddubsw %%ymm4,%%ymm2,%%ymm2           \n"
      "vpmaddubsw %%ymm4,%%ymm3,%%ymm3           \n"
      "vpaddw     %%ymm2,%%ymm0,%%ymm0           \n"
      "vpaddw     %%ymm3,%%ymm1,%%ymm1           \n" MEMOPREG(
          vmovdqu, 0x00, 0, 4, 1, ymm2)       //  vmovdqu  (%0,%4,1),%%ymm2
...
void ScaleRowDown34_1_Box_SSSE3(const uint8* src_ptr,
  ...
  asm volatile(LABELALIGN
               "1:                                          \n"
               "movdqu    (%0),%%xmm6                     \n" MEMOPREG(
                   movdqu, 0x00, 0, 3, 1, xmm7)  //  movdqu  (%0,%3),%%xmm7
               "pavgb     %%xmm7,%%xmm6                   \n"
               "pshufb    %%xmm2,%%xmm6                   \n"
               "pmaddubsw %%xmm5,%%xmm6                   \n"
               "paddsw    %%xmm1,%%xmm6                   \n"
               ...
               "movq      %%xmm6,(%1)                     \n"
               "movdqu    0x8(%0),%%xmm6                  \n" MEMOPREG(
                   movdqu, 0x8, 0, 3, 1, xmm7)  //  movdqu  0x8(%0,%3),%%xmm7
               "pavgb     %%xmm7,%%xmm6                   \n"
               "pshufb    %%xmm3,%%xmm6                   \n"
               "pmaddubsw %%xmm0,%%xmm6                   \n"
               "paddsw    %%xmm1,%%xmm6                   \n"
               ...
               "movq      %%xmm6,0x8(%1)                  \n"
               "movdqu    0x10(%0),%%xmm6                 \n" MEMOPREG(
                   movdqu, 0x10, 0, 3, 1, xmm7)  //  movdqu  0x10(%0,%3),%%xmm7
               "lea       0x20(%0),%0                     \n"
               "pavgb     %%xmm7,%%xmm6                   \n"
               "pshufb    %%xmm4,%%xmm6                   \n"
               "pmaddubsw %4,%%xmm6                       \n"
...
void ScaleRowDown34_0_Box_SSSE3(const uint8* src_ptr,
  ...
  asm volatile(LABELALIGN
               "1:                                          \n"
               "movdqu    (%0),%%xmm6                     \n" MEMOPREG(
                   movdqu, 0x00, 0, 3, 1, xmm7)  //  movdqu  (%0,%3,1),%%xmm7
               "pavgb     %%xmm6,%%xmm7                   \n"
               "pavgb     %%xmm7,%%xmm6                   \n"
               "pshufb    %%xmm2,%%xmm6                   \n"
               "pmaddubsw %%xmm5,%%xmm6                   \n"
               ...
               "movq      %%xmm6,(%1)                     \n"
               "movdqu    0x8(%0),%%xmm6                  \n" MEMOPREG(
                   movdqu, 0x8, 0, 3, 1, xmm7)  //  movdqu  0x8(%0,%3,1),%%xmm7
               "pavgb     %%xmm6,%%xmm7                   \n"
               "pavgb     %%xmm7,%%xmm6                   \n"
               "pshufb    %%xmm3,%%xmm6                   \n"
               "pmaddubsw %%xmm0,%%xmm6                   \n"
               ...
               "movq      %%xmm6,0x8(%1)                  \n"
               "movdqu    0x10(%0),%%xmm6                 \n" MEMOPREG(
                   movdqu, 0x10, 0, 3, 1, xmm7)  //  movdqu 0x10(%0,%3,1),%%xmm7
               "lea       0x20(%0),%0                     \n"
               "pavgb     %%xmm6,%%xmm7                   \n"
               "pavgb     %%xmm7,%%xmm6                   \n"
               "pshufb    %%xmm4,%%xmm6                   \n"
...
void ScaleRowDown38_2_Box_SSSE3(const uint8* src_ptr,
  ...
  asm volatile(LABELALIGN
               "1:                                          \n"
               "movdqu    (%0),%%xmm0                     \n" MEMOPREG(
                   movdqu, 0x00, 0, 3, 1, xmm1)  //  movdqu  (%0,%3,1),%%xmm1
               "lea       0x10(%0),%0                     \n"
               "pavgb     %%xmm1,%%xmm0                   \n"
               "movdqa    %%xmm0,%%xmm1                   \n"
               "pshufb    %%xmm2,%%xmm1                   \n"
...
void ScaleRowDown38_3_Box_SSSE3(const uint8* src_ptr,
  ...
  asm volatile(LABELALIGN
               "1:                                          \n"
               "movdqu    (%0),%%xmm0                     \n" MEMOPREG(
                   movdqu, 0x00, 0, 3, 1, xmm6)  //  movdqu  (%0,%3,1),%%xmm6
               "movhlps   %%xmm0,%%xmm1                   \n"
               "movhlps   %%xmm6,%%xmm7                   \n"
               "punpcklbw %%xmm5,%%xmm0                   \n"
               "punpcklbw %%xmm5,%%xmm1                   \n"
               ...
               "paddusw   %%xmm6,%%xmm0                   \n"
               "paddusw   %%xmm7,%%xmm1                   \n" MEMOPREG(
                   movdqu, 0x00, 0, 3, 2, xmm6)  //  movdqu  (%0,%3,2),%%xmm6
               "lea       0x10(%0),%0                     \n"
               "movhlps   %%xmm6,%%xmm7                   \n"
               "punpcklbw %%xmm5,%%xmm6                   \n"
               "punpcklbw %%xmm5,%%xmm7                   \n"
...
void ScaleFilterCols_SSSE3(uint8* dst_ptr,
  ...
  asm volatile(
      ...
      "movdqa    %%xmm2,%%xmm1                   \n"
      "paddd     %%xmm3,%%xmm2                   \n" MEMOPARG(
          movzwl, 0x00, 1, 3, 1, k2)  //  movzwl  (%1,%3,1),%k2
      "movd      %k2,%%xmm0                      \n"
      "psrlw     $0x9,%%xmm1                     \n" MEMOPARG(
          movzwl, 0x00, 1, 4, 1, k2)  //  movzwl  (%1,%4,1),%k2
      "movd      %k2,%%xmm4                      \n"
      "pshufb    %%xmm5,%%xmm1                   \n"
      "punpcklwd %%xmm4,%%xmm0                   \n"
      "psubb     %8,%%xmm0                       \n"  // make pixels signed.
...
void ScaleARGBRowDownEven_SSE2(const uint8* src_argb,
  ...
  asm volatile(
      ...
      "punpckldq %%xmm1,%%xmm0                   \n" MEMOPREG(
          movd, 0x00, 0, 1, 2, xmm2)       //  movd      (%0,%1,2),%%xmm2
...
void ScaleARGBRowDownEvenBox_SSE2(const uint8* src_argb,
  ...
  asm volatile(
      ...
      "1:                                          \n"
      "movq      (%0),%%xmm0                     \n" MEMOPREG(
          movhps, 0x00, 0, 1, 1, xmm0)       //  movhps    (%0,%1,1),%%xmm0
      MEMOPREG(movq, 0x00, 0, 1, 2, xmm1)    //  movq      (%0,%1,2),%%xmm1
      MEMOPREG(movhps, 0x00, 0, 4, 1, xmm1)  //  movhps    (%0,%4,1),%%xmm1
      "lea       0x00(%0,%1,4),%0                \n"
      "movq      (%5),%%xmm2                     \n" MEMOPREG(
          movhps, 0x00, 5, 1, 1, xmm2)       //  movhps    (%5,%1,1),%%xmm2
...
void ScaleARGBCols_SSE2(uint8* dst_argb,
  ...
  asm volatile(
      ...
      LABELALIGN "40:                                         \n" MEMOPREG(
          movd, 0x00, 3, 0, 4, xmm0)       //  movd      (%3,%0,4),%%xmm0
      MEMOPREG(movd, 0x00, 3, 1, 4, xmm1)  //  movd      (%3,%1,4),%%xmm1
      "pextrw    $0x5,%%xmm2,%k0                 \n"
      "pextrw    $0x7,%%xmm2,%k1                 \n"
      "paddd     %%xmm3,%%xmm2                   \n"
      "punpckldq %%xmm1,%%xmm0                   \n" MEMOPREG(
          movd, 0x00, 3, 0, 4, xmm1)       //  movd      (%3,%0,4),%%xmm1
...
void ScaleARGBFilterCols_SSSE3(uint8* dst_argb,
  ...
  asm volatile(
      ...
      "movdqa    %%xmm2,%%xmm1                   \n"
      "paddd     %%xmm3,%%xmm2                   \n" MEMOPREG(
          movq, 0x00, 1, 3, 4, xmm0)  //  movq      (%1,%3,4),%%xmm0
      "psrlw     $0x9,%%xmm1                     \n" MEMOPREG(
          movhps, 0x00, 1, 4, 4, xmm0)  //  movhps    (%1,%4,4),%%xmm0
      "pshufb    %%xmm5,%%xmm1                   \n"
      "pshufb    %%xmm4,%%xmm0                   \n"
      "pxor      %%xmm6,%%xmm1                   \n"
      "pmaddubsw %%xmm1,%%xmm0                   \n"
