...
#define YUVTORGB(yuvconstants)                                            \
  xmm3 = _mm_add_epi8(xmm3, *(__m128i*)yuvconstants->kUVBias);            \
...
#define YUVTORGB_AVX2(YuvConstants) \
  __asm {                                                                      \
    __asm vmovdqa    ymm0, ymmword ptr [YuvConstants + KUVBIAS]                \
    __asm vpaddb     ymm3, ymm0, ymm3                                          \
...
#define YUVTORGB(YuvConstants) \
  __asm {                                                                      \
    __asm movdqa     xmm0, xmmword ptr [YuvConstants + KUVBIAS]                \
    __asm paddb      xmm3, xmm0                                                \
