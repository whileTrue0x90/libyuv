...
void NV21ToYUV24Row_NEON0(const uint8_t* src_y,
                         const uint8_t* src_vu,
                         uint8_t* dst_yuv24,
                         int width) {
  asm volatile(
...
void NV21ToYUV24Row_NEON(const uint8_t* src_y,
                         ...
                         int width) {
  asm volatile(
      "ld1         {v19.16b,v20.16b,v21.16b}, [%4]\n"  // 3 shuffler constants
      "1:                                        \n"
      "ldp         q0, q2, [%0], #32             \n"   // load 32 Y values
      "ldp         q1, q3, [%1], #32             \n"   // load 32 VU values
      "tbl         v4.16b, {v0.16b,v1.16b}, v19.16b\n" // weave into YUV24
      "tbl         v5.16b, {v0.16b,v1.16b}, v20.16b\n"
      "tbl         v6.16b, {v0.16b,v1.16b}, v21.16b\n"
      "prfm        pldl1keep, [%0, 448]          \n"
      "tbl         v16.16b, {v2.16b,v3.16b}, v19.16b\n" // weave into YUV24
      "tbl         v17.16b, {v2.16b,v3.16b}, v20.16b\n"
      "tbl         v18.16b, {v2.16b,v3.16b}, v21.16b\n"
      "prfm        pldl1keep, [%1, 448]          \n"
      "subs        %w3, %w3, #32                 \n"  // 32 pixels per loop
      "st1         {v4.16b,v5.16b,v6.16b}, [%2], #48\n"  // store 16 YUV pixels
      "st1         {v16.16b,v17.16b,v18.16b}, [%2], #48\n"  // store 16 YUV pixels
      "b.gt        1b                            \n"
      : "+r"(src_y),      // %0
        "+r"(src_vu),     // %1
        "+r"(dst_yuv24),  // %2
