...
// Convert I410 to P410
LIBYUV_API
int I410ToP410(const uint16_t* src_y,
               int src_stride_y,
               const uint16_t* src_u,
               int src_stride_u,
               const uint16_t* src_v,
...
// Convert I412 to P412
LIBYUV_API
int I412ToP412(const uint16_t* src_y,
               int src_stride_y,
               const uint16_t* src_u,
               int src_stride_u,
               const uint16_t* src_v,
...
// Convert P210 to I210
LIBYUV_API
int P210ToI210(const uint16_t* src_y,
               int src_stride_y,
               const uint16_t* src_uv,
               int src_stride_uv,
               uint16_t* dst_y,
...
// Convert P410 to I410
LIBYUV_API
int P410ToI410(const uint16_t* src_y,
               int src_stride_y,
               const uint16_t* src_uv,
               int src_stride_uv,
               uint16_t* dst_y,
...
// Convert P212 to I212
LIBYUV_API
int P212ToI212(const uint16_t* src_y,
               int src_stride_y,
               const uint16_t* src_uv,
               int src_stride_uv,
               uint16_t* dst_y,
...
// Convert P412 to I412
LIBYUV_API
int P412ToI412(const uint16_t* src_y,
               int src_stride_y,
               const uint16_t* src_uv,
               int src_stride_uv,
               uint16_t* dst_y,
