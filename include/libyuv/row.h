...
void ABGRToYJRow_NEON(const uint8_t* src_argb, uint8_t* dst_y, int width);
...
void ARGBToUVJRow_NEON(const uint8_t* src_argb,
                       ...
                       uint8_t* dst_v,
                       int width);
void ABGRToUVJRow_NEON(const uint8_t* src_argb,
                       int src_stride_argb,
                       uint8_t* dst_u,
                       uint8_t* dst_v,
                       int width);
...
void ARGBToUVJRow_AVX2(const uint8_t* src_argb,
                       ...
                       uint8_t* dst_v,
                       int width);
void ABGRToUVJRow_AVX2(const uint8_t* src_argb,
                       int src_stride_argb,
                       uint8_t* dst_u,
                       uint8_t* dst_v,
                       int width);
...
void ARGBToUVJRow_SSSE3(const uint8_t* src_argb,
                        ...
                        uint8_t* dst_v,
                        int width);
void ABGRToUVJRow_SSSE3(const uint8_t* src_argb,
                        int src_stride_argb,
                        uint8_t* dst_u,
                        uint8_t* dst_v,
                        int width);
