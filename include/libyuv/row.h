...
void RGB565ToYRow_Any_NEON(const uint8_t* src_ptr,
                           uint8_t* dst_ptr,
                           int width);
...
void ARGBCopyAlphaRow_SSE2(const uint8_t* src,
                           uint8_t* dst,
                           int width);
void ARGBCopyAlphaRow_AVX2(const uint8_t* src,
                           uint8_t* dst,
                           int width);
...
void RGB565ToARGBRow_SSE2(const uint8_t* src,
                          uint8_t* dst,
                          int width);
void ARGB1555ToARGBRow_SSE2(const uint8_t* src,
                            uint8_t* dst,
                            int width);
void ARGB4444ToARGBRow_SSE2(const uint8_t* src,
                            uint8_t* dst,
                            int width);
...
void RGB24ToARGBRow_Any_MSA(const uint8_t* src_ptr,
                            uint8_t* dst_ptr,
                            int width);
void RAWToARGBRow_Any_NEON(const uint8_t* src_ptr,
                           uint8_t* dst_ptr,
                           int width);
...
void RAWToRGB24Row_Any_NEON(const uint8_t* src_ptr,
                            uint8_t* dst_ptr,
                            int width);
void RAWToRGB24Row_Any_MSA(const uint8_t* src_ptr,
                           uint8_t* dst_ptr,
                           int width);
...
void ARGBToARGB1555Row_SSE2(const uint8_t* src,
                            uint8_t* dst,
                            int width);
void ARGBToARGB4444Row_SSE2(const uint8_t* src,
                            uint8_t* dst,
                            int width);
...
void I400ToARGBRow_Any_SSE2(const uint8_t* src_ptr, uint8_t* dst_ptr, int width);
void I400ToARGBRow_Any_AVX2(const uint8_t* src_ptr, uint8_t* dst_ptr, int width);
void I400ToARGBRow_Any_NEON(const uint8_t* src_ptr, uint8_t* dst_ptr, int width);
...
void ARGBToRGB24Row_Any_NEON(const uint8_t* src_ptr,
                             uint8_t* dst_ptr,
                             int width);
void ARGBToRAWRow_Any_NEON(const uint8_t* src_ptr,
                           uint8_t* dst_ptr,
                           int width);
