...
// Merge separate 16 bit R, G, B and A planes into one interleaved AR30 plane.
// Alpha bits are filled with opaque value.
LIBYUV_API
...
// Merge separate 16 bit R, G, B and A planes into one interleaved AR64 plane.
// src_a can be NULL to fill opaque value to alpha.
LIBYUV_API
...
// Merge separate 16 bit R, G, B and A planes into one interleaved ARGB plane.
// src_a can be NULL to fill opaque value to alpha.
LIBYUV_API
