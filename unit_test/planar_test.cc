...
TEST_F(LibYUVPlanarTest, TestARGBGray) {
  ...
  EXPECT_EQ(29u, orig_pixels[0][0]);
  EXPECT_EQ(29u, orig_pixels[0][1]);
  EXPECT_EQ(29u, orig_pixels[0][2]);
  ...
  EXPECT_EQ(77u, orig_pixels[2][0]);
  EXPECT_EQ(77u, orig_pixels[2][1]);
  EXPECT_EQ(77u, orig_pixels[2][2]);
  ...
  EXPECT_EQ(97u, orig_pixels[5][0]);
  EXPECT_EQ(97u, orig_pixels[5][1]);
  EXPECT_EQ(97u, orig_pixels[5][2]);
...
TEST_F(LibYUVPlanarTest, TestARGBGrayTo) {
  ...
  EXPECT_EQ(29u, gray_pixels[0][0]);
  EXPECT_EQ(29u, gray_pixels[0][1]);
  EXPECT_EQ(29u, gray_pixels[0][2]);
  ...
  EXPECT_EQ(77u, gray_pixels[2][0]);
  EXPECT_EQ(77u, gray_pixels[2][1]);
  EXPECT_EQ(77u, gray_pixels[2][2]);
  ...
  EXPECT_EQ(97u, gray_pixels[5][0]);
  EXPECT_EQ(97u, gray_pixels[5][1]);
  EXPECT_EQ(97u, gray_pixels[5][2]);
