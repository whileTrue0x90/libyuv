...
TESTPLANARTOE(I420, 2, 2, ARGB, 1, 4, ABGR, ARM_YUV_ERROR)
TESTPLANARTOE(J420, 2, 2, ARGB, 1, 4, ARGB, ARM_YUV_ERROR)
TESTPLANARTOE(J420, 2, 2, ABGR, 1, 4, ARGB, ARM_YUV_ERROR)
TESTPLANARTOE(H420, 2, 2, ARGB, 1, 4, ARGB, ARM_YUV_ERROR)
TESTPLANARTOE(H420, 2, 2, ABGR, 1, 4, ARGB, ARM_YUV_ERROR)
TESTPLANARTOE(I420, 2, 2, BGRA, 1, 4, ARGB, ARM_YUV_ERROR)
TESTPLANARTOE(I420, 2, 2, ABGR, 1, 4, ARGB, ARM_YUV_ERROR)
TESTPLANARTOE(I420, 2, 2, RGBA, 1, 4, ARGB, ARM_YUV_ERROR)
TESTPLANARTOE(I420, 2, 2, RGB24, 1, 3, ARGB, ARM_YUV_ERROR)
TESTPLANARTOE(I420, 2, 2, RAW, 1, 3, RGB24, ARM_YUV_ERROR * 3 / 4)
TESTPLANARTOE(I420, 2, 2, RGB24, 1, 3, RAW, ARM_YUV_ERROR * 3 / 4)
TESTPLANARTOE(I420, 2, 2, ARGB, 1, 4, RAW, ARM_YUV_ERROR * 3 / 4)
TESTPLANARTOE(I420, 2, 2, RAW, 1, 3, ARGB, ARM_YUV_ERROR)
TESTPLANARTOE(H420, 2, 2, RGB24, 1, 3, ARGB, ARM_YUV_ERROR)
TESTPLANARTOE(H420, 2, 2, RAW, 1, 3, RGB24, ARM_YUV_ERROR * 3 / 4)
TESTPLANARTOE(H420, 2, 2, RGB24, 1, 3, RAW, ARM_YUV_ERROR * 3 / 4)
TESTPLANARTOE(H420, 2, 2, ARGB, 1, 4, RAW, ARM_YUV_ERROR * 3 / 4)
TESTPLANARTOE(H420, 2, 2, RAW, 1, 3, ARGB, ARM_YUV_ERROR)
TESTPLANARTOE(I420, 2, 2, ARGB, 1, 4, RGB565, ARM_YUV_ERROR / 2)
TESTPLANARTOE(I420, 2, 2, ARGB, 1, 4, ARGB1555, ARM_YUV_ERROR / 2)
TESTPLANARTOE(I420, 2, 2, ARGB, 1, 4, ARGB4444, ARM_YUV_ERROR / 2)
TESTPLANARTOE(I422, 2, 1, ARGB, 1, 4, RGB565, ARM_YUV_ERROR / 2)
TESTPLANARTOE(J422, 2, 1, ARGB, 1, 4, ARGB, ARM_YUV_ERROR)
TESTPLANARTOE(J422, 2, 1, ABGR, 1, 4, ARGB, ARM_YUV_ERROR)
TESTPLANARTOE(H422, 2, 1, ARGB, 1, 4, ARGB, ARM_YUV_ERROR)
TESTPLANARTOE(H422, 2, 1, ABGR, 1, 4, ARGB, ARM_YUV_ERROR)
TESTPLANARTOE(I422, 2, 1, BGRA, 1, 4, ARGB, ARM_YUV_ERROR)
TESTPLANARTOE(I422, 2, 1, ABGR, 1, 4, ARGB, ARM_YUV_ERROR)
TESTPLANARTOE(I422, 2, 1, RGBA, 1, 4, ARGB, ARM_YUV_ERROR)
TESTPLANARTOE(I444, 1, 1, ARGB, 1, 4, ARGB, ARM_YUV_ERROR)
TESTPLANARTOE(J444, 1, 1, ARGB, 1, 4, ARGB, ARM_YUV_ERROR)
TESTPLANARTOE(I444, 1, 1, ABGR, 1, 4, ARGB, ARM_YUV_ERROR)
TESTPLANARTOE(I420, 2, 2, YUY2, 2, 4, ARGB, ARM_YUV_ERROR)
TESTPLANARTOE(I420, 2, 2, UYVY, 2, 4, ARGB, ARM_YUV_ERROR)
TESTPLANARTOE(I422, 2, 1, YUY2, 2, 4, ARGB, ARM_YUV_ERROR)
TESTPLANARTOE(I422, 2, 1, UYVY, 2, 4, ARGB, ARM_YUV_ERROR)
...
TESTQPLANARTOE(I420Alpha, 2, 2, ARGB, 1, 4, ABGR, ARM_YUV_ERROR)
TESTQPLANARTOE(I420Alpha, 2, 2, ABGR, 1, 4, ARGB, ARM_YUV_ERROR)
...
TESTPLANAR16TOB(H010, 2, 2, AR30, 4, 4, 1, 2, AR30, ARM_YUV_ERROR)
TESTPLANAR16TOB(H010, 2, 2, ARGB, 4, 4, 1, 2, ARGB, ARM_YUV_ERROR)
