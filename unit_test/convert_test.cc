...
#define TESTPLANARTOPI(SRC_FMT_PLANAR, SRC_T, SRC_BPC, SRC_MASK,              \
                       ...
                       DST_BPC, DST_SUBSAMP_X, DST_SUBSAMP_Y, W1280, N, NEG,  \
                       OFF)                                                   \
...
#define TESTPLANARTOP(SRC_FMT_PLANAR, SRC_T, SRC_BPC, SRC_MASK, SRC_SUBSAMP_X, \
  ...
  TESTPLANARTOPI(SRC_FMT_PLANAR, SRC_T, SRC_BPC, SRC_MASK, SRC_SUBSAMP_X,      \
                 ...
                 DST_SUBSAMP_Y, benchmark_width_ - 4, _Any, +, 0)              \
  TESTPLANARTOPI(SRC_FMT_PLANAR, SRC_T, SRC_BPC, SRC_MASK, SRC_SUBSAMP_X,      \
                 SRC_SUBSAMP_Y, FMT_PLANAR, DST_T, DST_BPC, DST_SUBSAMP_X,     \
                 DST_SUBSAMP_Y, benchmark_width_, _Unaligned, +, 1)            \
  TESTPLANARTOPI(SRC_FMT_PLANAR, SRC_T, SRC_BPC, SRC_MASK, SRC_SUBSAMP_X,      \
                 SRC_SUBSAMP_Y, FMT_PLANAR, DST_T, DST_BPC, DST_SUBSAMP_X,     \
                 DST_SUBSAMP_Y, benchmark_width_, _Invert, -, 0)               \
  TESTPLANARTOPI(SRC_FMT_PLANAR, SRC_T, SRC_BPC, SRC_MASK, SRC_SUBSAMP_X,      \
                 SRC_SUBSAMP_Y, FMT_PLANAR, DST_T, DST_BPC, DST_SUBSAMP_X,     \
                 DST_SUBSAMP_Y, benchmark_width_, _Opt, +, 0)

TESTPLANARTOP(I420, uint8, 1, 0xff, 2, 2, I420, uint8, 1, 2, 2)
TESTPLANARTOP(I422, uint8, 1, 0xff, 2, 1, I420, uint8, 1, 2, 2)
TESTPLANARTOP(I444, uint8, 1, 0xff, 1, 1, I420, uint8, 1, 2, 2)
TESTPLANARTOP(I420, uint8, 1, 0xff, 2, 2, I422, uint8, 1, 2, 1)
TESTPLANARTOP(I420, uint8, 1, 0xff, 2, 2, I444, uint8, 1, 1, 1)
TESTPLANARTOP(I420, uint8, 1, 0xff, 2, 2, I420Mirror, uint8, 1, 2, 2)
TESTPLANARTOP(I422, uint8, 1, 0xff, 2, 1, I422, uint8, 1, 2, 1)
TESTPLANARTOP(I444, uint8, 1, 0xff, 1, 1, I444, uint8, 1, 1, 1)
TESTPLANARTOP(H010, uint16, 2, 0x3ff, 2, 2, H010, uint16, 2, 2, 2)
TESTPLANARTOP(H010, uint16, 2, 0x3ff, 2, 2, I420, uint8, 1, 2, 2)
