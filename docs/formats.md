...
# Color space
      The YUV formats start with a letter to specify the color space. e.g. I420
        ...
        J = BT.601 full range
        H = BT.709 limited range
        F = BT.709 full range
        U = BT.2020 limited range
...
# HDR formats
      Planar formats with 10 or 12 bits use the following fourcc:
        I010, I012m P010, P012 are half width, half height
        I210, I212m P210, P212 are half width, full height
        I410, I412m P410, P412 are full width, full height
      where
        I is the color space (see below) and 3 planes.
        0, 2 or 4 is the subsampling
        10 or 12 is the bits per channel.  The bits are in the low bits of a 16 bit channel.
        P is a biplanar format, similar to NV12 but 16 bits, with the valid bits in the high bits.
