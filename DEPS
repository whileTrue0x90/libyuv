...
vars = {
  ...
  'chromium_revision': '7aef8401a0b7c65d12e8ca545eb014ce9b83b832',
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + '8fa3e4ff0fc933700b8ece97e729954d4d73b158',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + '1594b9fcf9e789d07bcafbdba13954a30161f903',
  ...
  'src/base': {
    'url': Var('chromium_git') + '/chromium/src/base' + '@' + 'c1df3743edf2649a43d1e7ebe29b663ccf8dce7a',
    'condition': 'checkout_android',
  },
  ...
  'src/third_party/mockito/src': {
    'url': Var('chromium_git') + '/external/mockito/mockito.git' + '@' + '2280cac9ebb5849165731040eb9d720525ee9edb',
    'condition': 'checkout_android',
  },
  ...
  # iOS deps:
  'src/ios': {
    'url': Var('chromium_git') + '/chromium/src/ios' + '@' + 'dbdcbb9d1d07194f4428a663a9904c7f4e12bfce',
