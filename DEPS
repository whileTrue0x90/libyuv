vars = {
  ...
  'chromium_revision': 'f66bd4003032a6258fcfbed757f27bf2d4960ec2',
...
deps = {
  ...
  'src/third_party/harfbuzz-ng/src':
    Var('chromium_git') + '/external/github.com/harfbuzz/harfbuzz.git' + '@' + '8aaab78efcac81a05ec919be13792c98741ea1b5',
  ...
  'src/base': {
    'url': Var('chromium_git') + '/chromium/src/base' + '@' + '3bb4c17711ce8df4f1dc964d80ee5c12273d58e6',
    'condition': 'checkout_android',
  },
