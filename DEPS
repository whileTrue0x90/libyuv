...
deps_os = {
  ...
  'win': {
    ...
    'libyuv/third_party/yasm/binaries':
...
pre_deps_hooks = [
  {
    ...
    'name': 'cleanup_links',
    'pattern': '.',
    'action': ['python', 'libyuv/cleanup_links.py'],
  },
]
...
hooks = [
  ...
  },
  {
    ...
    'action': [
        'python',
        'libyuv/build/landmines.py',
        '--landmine-scripts',
        'libyuv/tools_libyuv/get_landmines.py',
        '--src-dir',
        'libyuv',
    ],
  },
  ...
  # such dependencies we share with Chromium.
  {
    ...
    'action': ['python',
               'libyuv/build/android/play_services/update.py',
               'download'
    ],
  },
  {
    ...
    'pattern': '.',
    'action': ['python',
               'libyuv/build/android/update_deps/update_third_party_deps.py',
               'download',
               '-b', 'chromium-intellij',
  ...
  },
  {
    ...
    'name': 'sysroot',
    'pattern': '.',
    'action': ['python', 'libyuv/build/linux/sysroot_scripts/install-sysroot.py',
               '--running-as-hook'],
  },
  {
    ...
    'name': 'win_toolchain',
    'pattern': '.',
    'action': ['python', 'libyuv/build/vs_toolchain.py', 'update'],
  },
  ...
  {
    'name': 'binutils',
    'pattern': 'libyuv/third_party/binutils',
    'action': [
        'python',
        'libyuv/third_party/binutils/download.py',
    ],
  },
  {
    ...
    'name': 'clang',
    'pattern': '.',
    'action': ['python', 'libyuv/tools/clang/scripts/update.py', '--if-needed'],
  },
  {
    # Update LASTCHANGE.
    'name': 'lastchange',
    'pattern': '.',
    'action': ['python', 'libyuv/build/util/lastchange.py',
               '-o', 'libyuv/build/util/LASTCHANGE'],
  },
  # Pull GN binaries.
  {
    'name': 'gn_win',
    ...
    'action': [ 'download_from_google_storage',
                ...
                '--no_auth',
                '--bucket', 'chromium-gn',
                '-s', 'libyuv/buildtools/win/gn.exe.sha1',
    ],
  },
  {
    'name': 'gn_mac',
    ...
    'action': [ 'download_from_google_storage',
                ...
                '--no_auth',
                '--bucket', 'chromium-gn',
                '-s', 'libyuv/buildtools/mac/gn.sha1',
    ],
  },
  {
    'name': 'gn_linux64',
    ...
    'action': [ 'download_from_google_storage',
                ...
                '--no_auth',
                '--bucket', 'chromium-gn',
                '-s', 'libyuv/buildtools/linux64/gn.sha1',
    ],
  },
  # Pull clang-format binaries using checked-in hashes.
  {
    ...
    'action': [ 'download_from_google_storage',
                ...
                '-s', 'libyuv/buildtools/win/clang-format.exe.sha1',
    ],
  },
  {
    ...
    'action': [ 'download_from_google_storage',
                ...
                '--no_auth',
                '--bucket', 'chromium-clang-format',
                '-s', 'libyuv/buildtools/mac/clang-format.sha1',
    ],
  },
  {
    ...
    'action': [ 'download_from_google_storage',
                ...
                '--no_auth',
                '--bucket', 'chromium-clang-format',
                '-s', 'libyuv/buildtools/linux64/clang-format.sha1',
    ],
  },
  ...
  },
  {
    ...
    'action': [ 'download_from_google_storage',
                ...
                '--no_auth',
                '--bucket', 'chromium-luci',
                '-d', 'libyuv/tools/luci-go/linux64',
    ],
  },
  # Pull the Syzygy binaries, used for optimization and instrumentation.
  {
    ...
    'pattern': '.',
    'action': ['python',
               'libyuv/build/get_syzygy_binaries.py',
  ...
  },
  {
    ...
    'pattern': '\\.sha1',
    'action': ['python', 'libyuv/third_party/instrumented_libraries/scripts/download_binaries.py'],
  },
  {
    'name': 'clang_format_merge_driver',
    'pattern': '.',
    'action': [ 'python',
                'libyuv/tools/clang_format_merge_driver/install_git_hook.py',
    ],
  },
]
