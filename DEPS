vars = {
  ...
  'chromium_revision': 'c1cfec4f6014e085ca04b39befdbf67a1c80b6d3',
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + 'ef080cea9736378d35c4c2b748b20e0101a45fa6',
  ...
  'src/base': {
    'url': Var('chromium_git') + '/chromium/src/base' + '@' + '2661fd9a1618384a47ae620aef5dbbaf5451f426',
    'condition': 'checkout_android',
  },
