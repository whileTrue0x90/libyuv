vars = {
  ...
  'chromium_revision': 'ad4fe6f11dc2008caee1a8acdd038a40ff40c140',
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + '083414256d68772c33535c35024f46502fb1d191',
  ...
  'src/base': {
    'url': Var('chromium_git') + '/chromium/src/base' + '@' + 'ac9448513e4a259ac2baef975c4cf890bf6aee56',
    'condition': 'checkout_android',
  },
