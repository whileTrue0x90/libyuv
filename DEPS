vars = {
  ...
  'chromium_revision': 'dc0d5c203b5a2619828c7c53ea48bf32fb03d634',
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + '64e8a0a6467ef6342e9afcb6e7827bd2da6c38d5',
  ...
  'src/base': {
    'url': Var('chromium_git') + '/chromium/src/base' + '@' + '411c703eafcc19917f3bf892491219e10c26ed84',
    'condition': 'checkout_android',
  },
