vars = {
  ...
  'chromium_revision': 'b7ece1e208de3215928a8c91d971945b83ca1267',
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + '6a47cf8f5528c32962520eb1c90944b66b2ccfdd',
  ...
  'src/third_party/harfbuzz-ng/src':
    Var('chromium_git') + '/external/github.com/harfbuzz/harfbuzz.git' + '@' + '0d2727f4fe734af146785df10a44e3505e410ba1',
  'src/third_party/libjpeg_turbo':
    Var('chromium_git') + '/chromium/deps/libjpeg_turbo.git' + '@' + '61a2bbaa9aec89cb2c882d87ace6aba9aee49bb9',
  'src/third_party/yasm/source/patched-yasm':
    Var('chromium_git') + '/chromium/deps/yasm/patched-yasm.git' + '@' + '720b70524a4424b15fc57e82263568c8ba0496ad',
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + 'c41730b5240a3ecdd6d12343a25353706f4c60e5',
  ...
  'src/base': {
    'url': Var('chromium_git') + '/chromium/src/base' + '@' + '61347f6416478a5d1b0904b5fa4c4e3ae190fa2c',
    'condition': 'checkout_android',
  },
