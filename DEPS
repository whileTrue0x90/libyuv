vars = {
  ...
  'chromium_revision': 'dc58887b8ee0fab682a0167e4e559a6289d5bd34',
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + '20b351c48bf997c182ccd25dd980ad2af6fcbd57',
  ...
  'src/base': {
    'url': Var('chromium_git') + '/chromium/src/base' + '@' + 'a835d3f466290cc2e68d200288808a111ced0f1a',
    'condition': 'checkout_android',
  },
