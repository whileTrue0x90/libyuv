...
deps = {
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + 'c4d71fdf9091ab0c20cbdd7e0da449ecf1002ff3',
  ...
  'src/base': {
    'url': Var('chromium_git') + '/chromium/src/base' + '@' + 'b227ea5a5e554f3c947c69781f927e89e19675f2',
    'condition': 'checkout_android',
  },
