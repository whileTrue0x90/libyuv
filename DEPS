vars = {
  ...
  'chromium_revision': '0661c73c1d3222ac2986617a198f041e4626fe7b',
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + '5353453b778050db2ce80070f4dae1c8c793da33',
  ...
  'src/base': {
    'url': Var('chromium_git') + '/chromium/src/base' + '@' + 'ac1dbfef9756193f52bbd22795d6173d883da665',
    'condition': 'checkout_android',
  },
