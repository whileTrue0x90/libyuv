...
deps = {
  ...
  'src/third_party/freetype/src':
    Var('chromium_git') + '/chromium/src/third_party/freetype2.git' + '@' + 'fbbcf50367403a6316a013b51690071198962920',
  ...
  'src/base': {
    'url': Var('chromium_git') + '/chromium/src/base' + '@' + 'e7903828b61a05998425574d103c688d6cde39d1',
    'condition': 'checkout_android',
  },
